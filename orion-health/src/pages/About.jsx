...
const About = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description:
        'Specialized in gynecological care and maternal health. Our maternal health services encompass preconception counseling, prenatal care, and postpartum support. We prioritize the health of both mother and baby, offering education and resources to navigate the journey of pregnancy and motherhood. Our compassionate team is here to address any concerns, ensuring a safe and healthy experience for every family.',
    },
    {
      title: 'Skin Health',
      description:
  ...
  return (
    ...
    >
      ...
      <div
        className="flex flex-col sm:flex-row items-center rounded-lg shadow-lg overflow-hidden w-full max-w-4xl"
        style={{ backgroundColor: 'var(--bg-color)', color: 'var(--text-color)' }}
      >
        <img
        ...
        <div className="p-6 space-y-4">
          <p>
            <strong className="text-lg">Our Commitment:</strong> At Orion Health, we are dedicated to
            your well-being with quality healthcare services that meet your unique needs, from routine
            check-ups to specialized treatments. Our dedicated team includes general physicians,
            dermatologists, gynecologists, pediatricians, and neurologists, each bringing expert care
            to help you achieve and maintain a healthy life.
          </p>
          <p>
            <strong className="text-lg">Our Goal:</strong> Our specialists provide a wide range of
            services. General physicians focus on preventive care, dermatologists offer skin health
            and cosmetic treatments, and gynecologists support women’s health at every stage. For
            families, our pediatricians ensure comprehensive child health care, and our neurologists
            deliver advanced treatments for complex neurological conditions.
          </p>
        </div>
      </div>
      ...
      <div
        className="block md:hidden p-4 w-full max-w-4xl rounded-lg"
        style={{
