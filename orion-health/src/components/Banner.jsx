...
const Banner = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row bg-maroon rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-5 md:mx-10">
      {/* ---- Left Side ---- */}
      <div className="flex-1 py-8 sm:py-4 md:py-8 lg:py-10 lg:pl-5" style={{ flex: '30%' }}>
        <div className="text-xl sm:text-2xl md:text-3xl lg:text-5xl font-semibold text-white">
          ...
          <p className="mt-4 text-sm sm:text-base text-gray-300">
            Help your family and friends access top-notch healthcare by creating an account for them.
            With ORION Health, staying healthy and connected has never been easier. Join us in
            prioritizing the well-being of those you care about!
          </p>
        </div>
        <button
